...
public class StopWords {
				...
				"This", "Those", "Through", "To", "Too", "Under", "Until", "Up", "Very", "Was", "Wasn’t", "We", "We’d", "We’ll", "We’re", "We’ve",
				"Were", "Weren’t", "What", "What’s", "When", "When’s", "Where", "Where’s", "Which", "While", "Who", "Who’s", "Whom",
				"Why", "Why’s", "With", "Won’t", "Would", "Wouldn’t", "You", "You’d", "You’ll", "You’re", "You’ve", "Your", "Yours", "Yourself", "Yourselves", "Professor", "professor",  "Of", "of"
				};
				
		public String get_clean_text(String s){
			String _s = "";
		...
		public static void main(String [] args){
			...
			System.out.println(sw.get_clean_text("Professor of Biomedical Data Sciences, and of Statistics, Stanford University").replace(",","").toLowerCase());
		}
}